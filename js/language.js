...
(function() {
    ...
    const TRANSLATIONS = {
        de: {
            ...
            text6: "Links zu externen Plattformen (LinkedIn, XING, Bluesky, Mastodon, Instagram, SoundCloud, YouTube, Bandcamp, Unsplash, GitHub) unterliegen deren eigenen Datenschutzbestimmungen.",
            email: "E-Mail",
            emailPrefix: "hallo",
        ...
        en: {
            ...
            text6: "Links to external platforms (LinkedIn, XING, Bluesky, Mastodon, Instagram, SoundCloud, YouTube, Bandcamp, Unsplash, GitHub) are subject to their own privacy policies.",
            email: "Email",
            emailPrefix: "hello",
        ...
        da: {
            ...
            text6: "Links til eksterne platforme (LinkedIn, XING, Bluesky, Mastodon, Instagram, SoundCloud, YouTube, Bandcamp, Unsplash, GitHub) er underlagt deres egne privatlivspolitikker.",
            email: "E-Mail",
            emailPrefix: "hej",
