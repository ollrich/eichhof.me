...
<body data-lang="<?= $lang ?>"<?= $openOverlay ? ' data-overlay="' . $openOverlay . '"' : '' ?>>
    ...
    <div class="container">
        ...
        <nav class="links" aria-label="Social Links">
            ...
            <!-- Slot 2: Instagram ↔ Pixelfed (coming soon, kein Link) -->
            ...
            <span class="link-card pixelfed profile-eu profile-eu-soon" aria-disabled="true">
                <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <span class="coming-soon"><?= $e($m['pixelfedSoon']) ?></span>
            </span>
