...
<body data-lang="<?= $lang ?>"<?= $openOverlay ? ' data-overlay="' . $openOverlay . '"' : '' ?>>
    ...
    <div class="container">
        ...
        <!-- Social media and contact links.
             Reihenfolge bewusst alphabetisch (Bluesky, Instagram, LinkedIn):
             neutraler als eine Gewichtung nach Beruflichkeit — und trifft
             zufällig die tatsächliche Nutzungsintensität. E-Mail bleibt
             ans Ende gesetzt, weil es kein Profil, sondern die Kontaktaktion ist. -->
        <nav class="links" aria-label="Social Links">
            <a href="https://bsky.app/profile/ollri.ch" target="_blank" rel="noopener noreferrer me" class="link-card bluesky">
            ...
            <a href="https://www.instagram.com/ollri.ch/" target="_blank" rel="noopener noreferrer me" class="link-card instagram">
                <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="<?= $m['linkedinUrl'] ?>" target="_blank" rel="noopener noreferrer me" class="link-card linkedin">
                <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="mobile-footer">
            ...
            <span class="mobile-footer-note" id="footer-text-mobile"><?= $rawHtml($m['footerMobile']) ?></span>
        </div>
    </div>
</main>
